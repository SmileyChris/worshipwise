...
describe('Services API', () => {
  ...
  describe('getServices', () => {
    ...
    it('should apply search filter', async () => {
      const mockServices = [
        createMockService({ id: 'service_1', title: 'Christmas Service' })
      ];
    ...
    it('should apply multiple filters', async () => {
      const mockServices = [
        createMockService({ id: 'service_1', status: 'completed' })
      ];
  ...
  describe('updateService', () => {
    ...
    it('should handle update errors', async () => {
      ...
      await expect(servicesApi.updateService('service_1', { title: 'New Title' })).rejects.toThrow('Update failed');
    });
  });
  ...
  describe('updateServiceSong', () => {
    ...
    it('should handle update errors', async () => {
      ...
      await expect(servicesApi.updateServiceSong('song_1', { transposed_key: 'G' })).rejects.toThrow('Update failed');
    });
  });
  ...
  describe('reorderServiceSongs', () => {
    it('should update positions for multiple songs', async () => {
      ...
      expect(mockPb.collection('service_songs').update).toHaveBeenCalledWith('song_1', { order_position: 2 });
      expect(mockPb.collection('service_songs').update).toHaveBeenCalledWith('song_2', { order_position: 1 });
    });
    ...
    it('should handle reorder errors', async () => {
      ...
      await expect(servicesApi.reorderServiceSongs('service_1', songOrder)).rejects.toThrow('Reorder failed');
    });
  });
  ...
  describe('completeService', () => {
    it('should mark service as completed and track usage', async () => {
      ...
      const serviceSongs = [
        createMockServiceSong({ song_id: 'song_a', order_position: 1 })
      ];
  ...
  describe('getUpcomingServices', () => {
    it('should return upcoming services from today forward', async () => {
      ...
      const mockServices = [
        createMockService({ service_date: today })
      ];
  ...
  describe('getTemplates', () => {
    it('should return template services', async () => {
      const mockTemplates = [
        createMockService({ is_template: true, title: 'Sunday Template' })
      ];
