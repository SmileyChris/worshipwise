  ...
  <form onsubmit={handleSubmit} class="space-y-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
      ...
      <div>
        ...
        {#if durationError}
          <p class="text-sm text-red-600 mt-1">{durationError}</p>
        {/if}
      </div>
    </div>
    ...
    <!-- Lyrics -->
    <div>
      <label for="lyrics" class="block text-sm font-medium leading-6 text-gray-900 mb-1">
        Lyrics
      </label>
      <textarea
        id="lyrics"
    ...
    <div class="space-y-4">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          <label for="chord_chart" class="block text-sm font-medium leading-6 text-gray-900 mb-1">
            Chord Chart
          </label>
          <input
            type="file"
        ...
        <div>
          <label for="audio_file" class="block text-sm font-medium leading-6 text-gray-900 mb-1">
            Audio File
          </label>
          <input
            type="file"
      ...
      <div>
        <label for="sheet_music" class="block text-sm font-medium leading-6 text-gray-900 mb-1">
    ...
    <!-- Notes -->
    <div>
      <label for="notes" class="block text-sm font-medium leading-6 text-gray-900 mb-1">
        Notes
      </label>
      <textarea
        id="notes"
